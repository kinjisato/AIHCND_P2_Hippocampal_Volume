...
def create_report(inference, header, orig_vol, pred_vol):
    ...
    header_font = ImageFont.truetype(r"/home/workspace/src/assets/Roboto-Regular.ttf", size=40)
    # main_font = ImageFont.truetype("assets/Roboto-Regular.ttf", size=20)
    main_font = ImageFont.truetype(r"/home/workspace/src/assets/Roboto-Regular.ttf", size=20)
    ...
    draw.multiline_text((10, 90),
                        ...
                        f"Image Orientation (Patient): {header.ImageOrientationPatient}\n"
                        f"Pixel Spacing: {header.PixelSpacing}\n"
                        f"Image Position (Patient): {header.ImagePositionPatient}\n"
                        f"Full volume Volume:{inference['total']}\n"
                        f"Anterior Volume:{inference['anterior']}\n"
                        f"Patient Name: {header.PatientName}\n"
                        f"Photometric Interpritation: {header.PhotometricInterpretation}\n",
